        ...
        <div className={styles.Digital}>
            <div className={styles.header}>
                ...
                <button className={styles.bread}>
                    Get Started 
                    <img className={styles.icon} src={getImageUrl("icons/whiteRightAngle.png")} alt="" />
                </button>
                <button className={styles.crumb}>
                    How It works
                    <img className={styles.icon} src={getImageUrl("icons/greyDownArrow.png")} alt="" />
                </button>
            </div>
            <div className={styles.banner}>
                <img className={styles.img} src={getImageUrl("Group 73.png")} alt="gr" />
                <img className={styles.i} src={getImageUrl("MHomeImg2.png")} alt="" />
            </div>
        </div>
    )
}